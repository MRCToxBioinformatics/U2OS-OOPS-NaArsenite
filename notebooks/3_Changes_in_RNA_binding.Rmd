...
plotTop10<-function(combined_exprs,lowest_p_proteins,suf){
  ...
  pdf(paste("../plots/",paste("Top-10-proteins_",suf,".pdf",sep=""),sep="/"),paper="a4r",width=12,height=8)
  n_pages = 2
  for (i in seq_len(n_pages)) {
      print(i)
        gp = ggplot(test_df,aes(Condition, Intensity, colour=Replicate, group=Replicate)) +
        geom_point() +
        geom_line() +
        xlab("") +
        ...
        facet_wrap_paginate(~Entry.name:Type, ncol=4, nrow=3, page=i,scales = "fixed")
        plot(gp)
  }
  dev.off()
}
